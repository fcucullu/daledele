...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    emoji: "🔄",
    description: "Ponerse, volverse, hacerse, quedarse, convertirse",
    exercises: [
      { sentence: "Cuando vio la nota, se ___ muy contento.", options: ["puso", "volvió", "hizo", "quedó"], answer: "puso", explanation: "'Ponerse' = cambio emocional o físico temporal (ponerse contento, nervioso, rojo).", type: "choice" },
      { sentence: "Con los años, se ___ una persona muy amargada.", options: ["volvió", "puso", "hizo", "quedó"], answer: "volvió", explanation: "'Volverse' = cambio radical de carácter o personalidad, generalmente negativo.", type: "choice" },
      { sentence: "Después de mucho esfuerzo, se ___ médico.", options: ["hizo", "puso", "volvió", "quedó"], answer: "hizo", explanation: "'Hacerse' = cambio gradual por esfuerzo propio (profesión, ideología).", type: "choice" },
      { sentence: "Tras el accidente, se ___ paralítico.", options: ["quedó", "puso", "volvió", "hizo"], answer: "quedó", explanation: "'Quedarse' = resultado permanente, generalmente negativo (quedarse ciego, solo, sin dinero).", type: "choice" },
      { sentence: "La oruga se ___ en mariposa.", options: ["convirtió", "puso", "volvió", "hizo"], answer: "convirtió", explanation: "'Convertirse en' = transformación completa en algo diferente.", type: "choice" },
      { sentence: "Con el tiempo, ___ a ser director de la empresa.", options: ["llegó", "se puso", "se volvió", "se quedó"], answer: "llegó", explanation: "'Llegar a ser' = alcanzar una posición o estado tras un proceso largo.", type: "choice" },
      { sentence: "Cuando le dieron la noticia, se ___ pálido.", options: ["puso", "volvió", "hizo", "quedó"], answer: "puso", explanation: "'Ponerse' = cambio físico involuntario y temporal.", type: "choice" },
      { sentence: "Se ___ vegetariano hace dos años.", answer: "hizo", explanation: "'Hacerse' = cambio por decisión propia (ideología, religión, dieta).", type: "write", hint: "(ponerse/volverse/hacerse/quedarse)" },
      { sentence: "Mi abuelo se ___ sordo con la edad.", answer: "quedó", explanation: "'Quedarse' = resultado permanente de un proceso.", type: "write", hint: "(ponerse/volverse/hacerse/quedarse)" },
      { sentence: "Se ___ loco cuando supo la verdad.", answer: "volvió", explanation: "'Volverse loco' = cambio radical (puede ser literal o figurado).", type: "write", hint: "(ponerse/volverse/hacerse/quedarse)" },
      { sentence: "Después de ganar la lotería, se ___ en una persona diferente.", options: ["convirtió", "puso", "hizo", "quedó"], answer: "convirtió", explanation: "'Convertirse en' = transformación total.", type: "choice" },
      { sentence: "Se ___ nervioso antes del examen.", options: ["puso", "volvió", "hizo", "quedó"], answer: "puso", explanation: "'Ponerse nervioso' = cambio emocional temporal.", type: "choice" },
      { sentence: "Con la crisis, muchas personas se ___ sin trabajo.", options: ["quedaron", "pusieron", "volvieron", "hicieron"], answer: "quedaron", explanation: "'Quedarse sin' = perder algo, resultado negativo.", type: "choice" },
      { sentence: "España se ___ en una democracia en 1978.", options: ["convirtió", "puso", "volvió", "hizo"], answer: "convirtió", explanation: "'Convertirse en' = transformación de un sistema/estructura.", type: "choice" },
    ],
  },
  {
    id: "relativos",
    ...
    emoji: "🔗",
    description: "Que, quien, cuyo, el que, lo que, donde",
    exercises: [
      { sentence: "La persona ___ llamó ayer es mi prima.", options: ["que", "quien", "cuyo", "la que"], answer: "que", explanation: "'Que' es el relativo más universal, funciona para personas y cosas.", type: "choice" },
      { sentence: "El profesor con ___ hablé es muy simpático.", options: ["quien", "que", "cuyo", "el que"], answer: "quien", explanation: "'Quien' se usa para personas después de preposición.", type: "choice" },
      { sentence: "El chico ___ padre es profesor se llama Juan.", options: ["cuyo", "que", "quien", "el que"], answer: "cuyo", explanation: "'Cuyo' indica posesión y concuerda con lo poseído (padre = masculino).", type: "choice" },
      { sentence: "No entiendo ___ dices.", options: ["lo que", "el que", "que", "quien"], answer: "lo que", explanation: "'Lo que' se refiere a ideas, conceptos o cosas no específicas.", type: "choice" },
      { sentence: "La ciudad ___ nací es muy pequeña.", options: ["donde", "que", "la que", "cuyo"], answer: "donde", explanation: "'Donde' se usa cuando el antecedente es un lugar.", type: "choice" },
      { sentence: "Los ___ quieran participar, que levanten la mano.", options: ["que", "quien", "cuyo", "lo que"], answer: "que", explanation: "'Los que' = las personas que (artículo + que).", type: "choice" },
      { sentence: "___ me preocupa es tu salud.", answer: "Lo que", explanation: "'Lo que' introduce una oración subordinada que funciona como sujeto.", type: "write", hint: "(lo que / el que / quien)" },
      { sentence: "La mujer a ___ vi ayer es tu hermana.", answer: "quien", explanation: "'A quien' = complemento directo de persona con preposición.", type: "write", hint: "(que / quien / cuyo)" },
      { sentence: "Es una empresa ___ productos son muy conocidos.", options: ["cuyos", "que", "donde", "los que"], answer: "cuyos", explanation: "'Cuyos' concuerda con 'productos' (masculino plural).", type: "choice" },
      { sentence: "La razón por ___ lo hice es personal.", options: ["la que", "que", "quien", "cuyo"], answer: "la que", explanation: "'Por la que' — después de 'razón' + preposición, se usa 'la que'.", type: "choice" },
      { sentence: "Hay personas a ___ no les gusta viajar.", options: ["las que", "que", "quien", "cuyo"], answer: "las que", explanation: "'A las que' — preposición + artículo + que para personas en plural.", type: "choice" },
      { sentence: "El momento en ___ te conocí fue especial.", options: ["el que", "que", "quien", "cuyo"], answer: "el que", explanation: "'En el que' — preposición + artículo + que para tiempo.", type: "choice" },
    ],
  },
  {
    id: "perifrasis",
    ...
    emoji: "⚙️",
    description: "Llevar, acabar de, soler, ponerse a, dejar de",
    exercises: [
      { sentence: "___ tres años viviendo en España.", options: ["Llevo", "Hace", "Desde", "Tengo"], answer: "Llevo", explanation: "'Llevar + gerundio' = duración de una acción que continúa. 'Llevo tres años viviendo'.", type: "choice" },
      { sentence: "___ de llegar, no he tenido tiempo de nada.", options: ["Acabo", "Llevo", "Suelo", "Dejo"], answer: "Acabo", explanation: "'Acabar de + infinitivo' = acción reciente, hace muy poco.", type: "choice" },
      { sentence: "___ ir al gimnasio tres veces por semana.", options: ["Suelo", "Llevo", "Acabo de", "Dejo de"], answer: "Suelo", explanation: "'Soler + infinitivo' = acción habitual.", type: "choice" },
      { sentence: "De repente se ___ a llorar.", options: ["puso", "dejó", "acabó", "siguió"], answer: "puso", explanation: "'Ponerse a + infinitivo' = empezar una acción de forma repentina.", type: "choice" },
      { sentence: "___ de fumar hace un año.", options: ["Dejé", "Acabé", "Llevé", "Solí"], answer: "Dejé", explanation: "'Dejar de + infinitivo' = interrumpir una acción/hábito.", type: "choice" },
      { sentence: "Hay que ___ más para aprobar.", options: ["estudiar", "estudiando", "estudiado", "estudie"], answer: "estudiar", explanation: "'Hay que + infinitivo' = obligación impersonal.", type: "choice" },
      { sentence: "___ estudiando cuando sonó el teléfono.", options: ["Seguía", "Solía", "Acababa de", "Dejaba de"], answer: "Seguía", explanation: "'Seguir/continuar + gerundio' = continuar una acción.", type: "choice" },
      { sentence: "¿Cuánto tiempo ___ esperando?", answer: "llevas", explanation: "'Llevar + gerundio' para preguntar por la duración de una acción en curso.", type: "write", hint: "(verbo: llevar)" },
      { sentence: "___ de comer cuando llegaste.", answer: "Acababa", explanation: "'Acabar de' en imperfecto = acción reciente en el pasado.", type: "write", hint: "(verbo: acabar)" },
      { sentence: "No ___ de hablar en toda la reunión.", answer: "dejó", explanation: "'Dejar de' = no paró de hablar.", type: "write", hint: "(verbo: dejar)" },
      { sentence: "___ cinco horas conduciendo sin parar.", options: ["Llevamos", "Hacemos", "Tenemos", "Somos"], answer: "Llevamos", explanation: "'Llevar + tiempo + gerundio' = duración acumulada.", type: "choice" },
      { sentence: "Al oír la noticia, se ___ a reír.", options: ["echó", "dejó", "puso", "llevó"], answer: "echó", explanation: "'Echarse a + infinitivo' = empezar de forma repentina (reír, llorar, correr).", type: "choice" },
      { sentence: "___ que terminar el proyecto antes del viernes.", options: ["Tenemos", "Llevamos", "Solemos", "Acabamos de"], answer: "Tenemos", explanation: "'Tener que + infinitivo' = obligación personal.", type: "choice" },
      { sentence: "Debes ___ estudiar más gramática.", answer: "de", explanation: "'Deber de + infinitivo' = probabilidad. 'Deber + infinitivo' (sin 'de') = obligación.", type: "write", hint: "(de / sin preposición)" },
    ],
  },
];
